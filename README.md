...
- [minishift or OpenShift + OpenShift s2i templates + Jenkins pipelines](#minishift-or-openshift--openshift-s2i-templates--jenkins-pipelines)
  ...
  - [Usage examples](#usage-examples)
    ...
    - [Example 8a: OpenShift cluster instance endpoint + Helper infra OS templates + OS templates from some project](#example-8a-openshift-cluster-instance-endpoint--helper-infra-os-templates--os-templates-from-some-project)
    - [Example 8b: From a File ex. ari-my-project.yml](#example-8b-from-a-file-ex-ari-my-projectyml)
